...
import {TournamentAttributes} from 'scioly-bot-types';
...
const TournamentEventsForm: FunctionComponent<FormProps> = ({
  id,
  tournamentName,
}) => {
  const errorStyle = {
  ...
  const [tournament, setTournament] = useState<TournamentAttributes | null>(
    null,
  );
          ...
          <form onSubmit={formik.handleSubmit}>
            <FormControl fullWidth margin="normal">
                  ...
                  <div style={{width: 'auto'}}>
                    ...
                    formik.values.tournamentEvents.length > 0 ? (
                      ...
                      <Button
                        ...
                        fullWidth
                        onClick={() =>
                          arrayHelpers.push({name: '', minutes: ''})
                        }>
                        Add event
                      </Button>
                    )}
              ...
              {typeof formik.errors.tournamentEvents === 'string' ? (
                <div style={{...errorStyle, marginBottom: '10px'}}>
